            ...
            <input
              ...
              <div className="flex justify-between px-20">
                  <div className="text-gray-400 flex">
                        ...
                        <div className="text-[18px] font-normal text-gray-500">
                        Drag and drop your files to upload
                        <p className="text-[14px] font-normal text-gray-500">Maximum 5MB per file</p>
                        </div>                 
                  </div>
             
                  <p className="text-[16px] cursor-pointer bg-blue-800 rounded-full font-bold text-white py-2 px-5" onClick={() => { fileRef.current.click();}}>
                      Choose file
                  </p>
              </div>
